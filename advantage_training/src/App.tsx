    ...
    <div>
      {isLoggedIn ? (
        <Routes>
          ...
          <Route path="/add-member" element={<AddMemberPage onAddMember={(member) => console.log(member)} />} />
          <Route path="/member/:id/add-movement-screen" element={<AddMovementScreenPage  />} />
          <Route path="/member/:memberId/edit-movement-screen/" element={<EditMovementScreen /> } />
          <Route path="member/:memberId/view-history/" element={<ViewHistoryPage />} />
{/* 
