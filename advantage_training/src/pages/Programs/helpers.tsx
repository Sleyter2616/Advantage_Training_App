...
export const handleProgramNameChange = (
  id: string,
  newName: string,
  programs: Program[],
...
export const handleDayNameChange = (
  programId: string,
  dayIndex: number,
  newName: string,
  programs: Program[],
...
export const handleMovementNameChange = (
  programId: string,
  dayIndex: number,
...
export const handleMovementSetsChange = (
  programId: string,
  dayIndex: number,
  movementIndex: number,
  newSets: string,
...
export const handleMovementRepsChange = (
  programId: string,
  dayIndex: number,
  movementIndex: number,
  newReps: string,
...
export const handleDeleteMovement = (
  programId: string,
  dayIndex: number,
  movementIndex: number,
  programs: Program[],
...
export const handleAddMovement = (
  programId: string,
  dayIndex: number,
  programs: Program[],
  setPrograms: React.Dispatch<React.SetStateAction<Program[]>>
